      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full ">
        ...
        <div className="bg-white rounded-lg shadow-sm dark:bg-gray-700">
          ...
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-600 border-gray-200">
            ...
            <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:bg-white cursor-pointer "  onClick={onClose}>
              X
            </button>
          </div>
          {/* Modal Body */}
